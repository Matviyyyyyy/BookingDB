...
urlpatterns = [
    ...
    path("add_review/<int:room_id>/", b_views.add_review, name="add-review"),
    path("user/", b_views.user_page, name = "user-page"),
    path("pay-payment/<payment_id>/", b_views.finish_payment, name = "pay-payment"),
    path("booking-services/<booking_id>/", b_views.services_booking, name = "booking-services"),
    path("add-service-to-booking/<booking_id>/", b_views.add_service_to_booking, name = "add-service-to-booking")
